...
var _validate = function _validate(config, exampleConfig, options) {
  ...
  for (var key in config) {
    ...
    } else if (shouldSkipValidationForPath(path, key, options.recursiveDenylist)) {// skip validating unknown options inside blacklisted paths
    } else {
...
var validate = function validate(config, options) {
  ...
  var combinedDenylist = [].concat(_toConsumableArray(_defaultConfig["default"].recursiveDenylist || []), _toConsumableArray(options.recursiveDenylist || []));
