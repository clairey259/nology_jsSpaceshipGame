...
var programVisitor = require('./visitor');

var readInitialCoverage = require('./read-coverage');
/**
...
function () {
  function Instrumenter() {
    ...
    this.opts = _objectSpread({}, defaults.instrumenter, {}, opts);
    ...
    value: function instrumentSync(code, filename, inputSourceMap) {
      ...
      var babelOpts = {
        ...
        plugins: [[function (_ref) {
          ...
          var ee = programVisitor(types, filename, {
      ...
      var codeMap = transformSync(code, babelOpts);

      if (!output || !output.fileCoverage) {
        var initialCoverage = readInitialCoverage(codeMap.ast) ||
