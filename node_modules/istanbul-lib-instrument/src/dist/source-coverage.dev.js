...
var _require = require('istanbul-lib-coverage'),
...
function (_classes$FileCoverage) {
  ...
  _createClass(SourceCoverage, [{
    ...
    value: function newBranch(type, loc) {
      var isReportLogic = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    key: "maybeNewBranchTrue",
    value: function maybeNewBranchTrue(type, name, isReportLogic) {
      if (!isReportLogic) {
        return;
      }
    ...
    key: "maybeAddBranchTrue",
    value: function maybeAddBranchTrue(name) {
      if (!this.data.bT) {
        return;
      }

      var countsTrue = this.data.bT[name];
