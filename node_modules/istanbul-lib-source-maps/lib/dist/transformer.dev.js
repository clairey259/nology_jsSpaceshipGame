  ...
  _createClass(SourceMapTransformer, [{
    ...
    value: function processFile(fc, sourceMap, coverageMapper) {
      ...
      Object.entries(fc.statementMap).forEach(function (_ref) {
        ...
        var mapping = _this.resolveMapping(sourceMap, loc, fc.path);
      ...
      Object.entries(fc.fnMap).forEach(function (_ref3) {
        ...
        var mapping = _this.resolveMapping(sourceMap, fnMeta.decl, fc.path);

        var spanMapping = _this.resolveMapping(sourceMap, fnMeta.loc, fc.path);
      ...
      Object.entries(fc.branchMap).forEach(function (_ref5) {
        ...
        var locMapping = branchMeta.loc ? _this.resolveMapping(sourceMap, branchMeta.loc, fc.path) : null;
