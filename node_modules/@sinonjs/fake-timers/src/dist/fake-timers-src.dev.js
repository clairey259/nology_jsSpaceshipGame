...
function withGlobal(_global) {
    ...
    if (addTimerReturnsObject) {
      var res = _defineProperty({
        ...
        refresh: function refresh() {
          timer.callAt = clock.now + (parseInt(timer.delay) || (clock.duringTick ? 1 : 0)); // it _might_ have been removed, but if not the assignment is perfectly fine
  ...
  function createClock(start, loopLimit) {
    ...
    function doTick(tickValue, isAsync, resolve, reject) {
      ...
      var previous = clock.now; // ESLint fails to detect this correctly
