...
function _ciInfo() {
  var data = require('ci-info');

  _ciInfo = function _ciInfo() {
    return data;
  };
...
var NODE_MODULES_REGEXP = (0, _jestRegexUtil().replacePathSepForRegex)(_constants.NODE_MODULES);
var defaultOptions = {
  automock: false,
  bail: 0,
  cache: true,
  ...
  transformIgnorePatterns: [NODE_MODULES_REGEXP, "\\.pnp\\.[^\\".concat(_path().sep, "]+$")],
  useStderr: false,
  watch: false,
