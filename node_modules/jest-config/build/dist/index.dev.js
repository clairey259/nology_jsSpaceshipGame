    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          skipMultipleConfigError = _args.length > 5 && _args[5] !== undefined ? _args[5] : false;
          configPath = null;
        ...
        case 24:
          ...
          configPath = (0, _resolveConfigPath["default"])(argv.config, process.cwd(), skipMultipleConfigError);
          _context.next = 28;
        ...
        case 31:
          ...
          configPath = (0, _resolveConfigPath["default"])(packageRootOrConfig, process.cwd(), skipMultipleConfigError);
          _context.next = 34;
          return regeneratorRuntime.awrap((0, _readConfigFileAndSetRootDir["default"])(configPath));
        ...
        case 35:
          _context.next = 37;
          return regeneratorRuntime.awrap((0, _normalize["default"])(rawOptions, argv, configPath, projectIndex));
...
function readConfigs(argv, projectPaths) {
  var globalConfig, hasDeprecationWarnings, configs, projects, configPath, parsedConfig, cwd, projectIsCwd, parsedConfigs;
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 11:
          ...
          cwd = process.platform === 'win32' ? (0, _jestUtil().tryRealpath)(process.cwd()) : process.cwd();
          projectIsCwd = projects[0] === cwd;
          _context2.next = 16;
