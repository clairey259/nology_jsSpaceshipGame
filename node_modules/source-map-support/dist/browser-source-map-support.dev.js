...
((void 0).define || function (G, J) {
  ...
  (function b(n, u, m) {
    ...
    5: [function (n, u, m) {
      function b(f, p, a) {
        if (!(this instanceof b)) return new b(f, p, a);

        var c = _typeof(f);

        if ("number" === c) var d = 0 < f ? f >>> 0 : 0;else if ("string" === c) {
          if ("base64" === p) for (f = (f.trim ? f.trim() : f.replace(/^\s+|\s+$/g, "")).replace(H, ""); 0 !== f.length % 4;) {
            f += "=";
          }
          d = b.byteLength(f, p);
        ...
        if (b.TYPED_ARRAY_SUPPORT && "number" === typeof f.byteLength) k._set(f);else {
          ...
          if (F(C) || b.isBuffer(C) || C && "object" === _typeof(C) && "number" === typeof C.length) {
            if (b.isBuffer(f)) for (p = 0; p < d; p++) {
              k[p] = f.readUInt8(p);
            } else for (p = 0; p < d; p++) {
              k[p] = (f[p] % 256 + 256) % 256;
            }
          } else if ("string" === c) k.write(f, 0, p);else if ("number" === c && !b.TYPED_ARRAY_SUPPORT && !a) for (p = 0; p < d; p++) {
            k[p] = 0;
          }
        }
        return k;
      ...
      function g(f, p, b) {
        ...
        if (f + p > b) throw new RangeError("Trying to access beyond buffer length");
      }

      function h(f, p, a, c, d, k) {
        if (!b.isBuffer(f)) throw new TypeError("buffer must be a Buffer instance");
        if (p > d || p < k) throw new TypeError("value is out of bounds");
      ...
      function l(f, p, b, a, c, d) {
        if (p > c || p < d) throw new TypeError("value is out of bounds");
      ...
      b.compare = function (f, a) {
        ...
        for (var c = f.length, p = a.length, d = 0, k = Math.min(c, p); d < k && f[d] === a[d]; d++) {
          ;
        }
        ...
        switch (d) {
          case "hex":
            ...
            for (d = 0; d < a; d++) {
              ...
              if (isNaN(p)) throw Error("Invalid hex string");
              this[b + d] = p;
            }
      ...
      b.prototype.slice = function (f, a) {
        ...
        for (var d = new b(c, void 0, !0), p = 0; p < c; p++) {
          d[p] = this[p + f];
        }
    ...
    16: [function (n, u, m) {
      ...
      e.fromSourceMap = function (a, b) {
        ...
        for (var h = a._mappings.toArray().slice(), r = c.__generatedMappings = [], m = c.__originalMappings = [], v = 0, n = h.length; v < n; v++) {
          var f = h[v],
              p = new g();
          p.generatedLine = f.generatedLine;
          p.generatedColumn = f.generatedColumn;
          f.source && (p.source = w.indexOf(f.source), p.originalLine = f.originalLine, p.originalColumn = f.originalColumn, f.name && (p.name = k.indexOf(f.name)), m.push(p));
          r.push(p);
        }
      ...
      e.prototype._parseMappings = function (a, b) {
        for (var c = 1, k = 0, e = 0, l = 0, w = 0, h = 0, m = a.length, v = 0, f = {}, p = {}, n = [], u = [], y, B, A, E, I; v < m;) {
          if (";" === a.charAt(v)) c++, v++, k = 0;else if ("," === a.charAt(v)) v++;else {
            ...
            if (A = f[B]) v += B.length;else {
              for (A = []; v < E;) {
                r.decode(a, v, p), I = p.value, v = p.rest, A.push(I);
              }
            ...
            u.push(y);
            "number" === typeof y.originalLine && n.push(y);
          }
        }
    ...
    17: [function (n, u, m) {
      ...
      b.prototype._serializeMappings = function () {
        for (var a = 0, b = 1, d = 0, h = 0, m = 0, n = 0, c = "", k, x, z, F = this._mappings.toArray(), D = 0, t = F.length; D < t; D++) {
          x = F[D];
          k = "";
          ...
          a = x.generatedColumn;
          null != x.source && (z = this._sources.indexOf(x.source), k += e.encode(z - n), n = z, k += e.encode(x.originalLine - 1 - h), h = x.originalLine - 1, k += e.encode(x.originalColumn - d), d = x.originalColumn, null != x.name && (x = this._names.indexOf(x.name), k += e.encode(x - m), m = x));
          c += k;
        }
    ...
    18: [function (n, u, m) {
      ...
      b.fromStringWithSourceMap = function (d, a, e) {
        ...
        var m = new b(),
            ...
            v = 0,
            c = function c() {
          var a = v < n.length ? n[v++] : void 0,
              b = (v < n.length ? n[v++] : void 0) || "";
          return a + b;
        },
            k = 1,
            x = 0,
        ...
        a.eachMapping(function (a) {
          if (null !== z) if (k < a.generatedLine) l(z, c()), k++, x = 0;else {
            ...
            n[v] = b.substr(a.generatedColumn - x);
            x = a.generatedColumn;
            l(z, d);
            z = a;
            return;
          ...
          x < a.generatedColumn && (b = n[v] || "", m.add(b.substr(0, a.generatedColumn)), n[v] = b.substr(a.generatedColumn), x = a.generatedColumn);
          z = a;
        }, this);
        v < n.length && (z && l(z, c()), m.add(n.splice(v).join("")));
        a.sources.forEach(function (b) {
          var c = a.sourceContentFor(b);
      ...
      b.prototype.toStringWithSourceMap = function (b) {
        ...
        this.walk(function (b, e) {
          a += b;
          null !== e.source && null !== e.line && null !== e.column ? (n === e.source && c === e.line && k === e.column && x === e.name || h.addMapping({
            source: e.source,
            original: {
              line: e.line,
              column: e.column
            ...
            name: e.name
          }), n = e.source, c = e.line, k = e.column, x = e.name, m = !0) : m && (h.addMapping({
            generated: {
              line: d,
              column: g
            }
          ...
          for (var l = 0, z = b.length; l < z; l++) {
            10 === b.charCodeAt(l) ? (d++, g = 0, l + 1 === z ? (n = null, m = !1) : m && h.addMapping({
              source: e.source,
              original: {
                line: e.line,
                column: e.column
    ...
    21: [function (n, u, m) {
      (function (b) {
        ...
        function q(b) {
          ...
          if (c) {
            var f = b.getLineNumber(),
                g = b.getColumnNumber() - 1;
            1 === f && 62 < g && !e() && !b.isEval() && (g -= 62);
            var h = d({
              source: c,
              line: f,
              column: g
          ...
          l && (l = a(l), b = r(b), b.getEvalOrigin = function () {
            return l;
          });
          return b;
        }
        ...
        function w(a, b) {
          H && (p = {}, C = {});
          return (a.name || "Error") + ": " + (a.message || "") + b.map(function (a) {
            return "\n    at " + q(a);
          }).join("");
        }
