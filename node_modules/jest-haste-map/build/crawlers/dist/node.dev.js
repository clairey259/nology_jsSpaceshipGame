  ...
  function search(directory) {
    ...
    fs().readdir(directory, {
      ...
      entries.forEach(function (entry) {
        ...
        activeCalls++;
        var stat = enableSymlinks ? fs().stat : fs().lstat;
...
function nodeCrawl(options) {
  var data, extensions, forceNodeFilesystemAPI, ignore, rootDir, enableSymlinks, roots, useNativeFind;
  return regeneratorRuntime.async(function nodeCrawl$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          data = options.data, extensions = options.extensions, forceNodeFilesystemAPI = options.forceNodeFilesystemAPI, ignore = options.ignore, rootDir = options.rootDir, enableSymlinks = options.enableSymlinks, roots = options.roots;
          _context2.next = 3;
