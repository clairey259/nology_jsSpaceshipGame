...
function (_Prompt) {
  ...
  function TextPrompt() {
    ...
    _this3 = _possibleConstructorReturn(this, _getPrototypeOf(TextPrompt).call(this, opts));
    _this3.transform = style.render(opts.style);
    _this3.scale = _this3.transform.scale;
    _this3.msg = opts.message;
    _this3.initial = opts.initial || "";
    ...
    _this3.cursor = Number(!!_this3.initial);
    _this3.cursorOffset = 0;
  ...
  _createClass(TextPrompt, [{
    ...
    key: "isCursorAtStart",
    value: function isCursorAtStart() {
      return this.cursor === 0 || this.placeholder && this.cursor === 1;
    }
  }, {
    key: "isCursorAtEnd",
    value: function isCursorAtEnd() {
