          ...
          try {
            for (var _iterator = meta.source[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              ...
              if ((0, _helperModuleTransforms.isSideEffectImport)(metadata)) {
                ...
                if (metadata.lazy) {
                  header = _core.template.statement.ast(_templateObject2(), metadata.name, init, metadata.name);
                } else {
                  header = _core.template.statement.ast(_templateObject3(), metadata.name, init);
                }
              }

              header.loc = metadata.loc;
              headers.push(header);
              headers.push.apply(headers, _toConsumableArray((0, _helperModuleTransforms.buildNamespaceInitStatements)(meta, metadata, constantReexports)));
            }
          } catch (err) {
