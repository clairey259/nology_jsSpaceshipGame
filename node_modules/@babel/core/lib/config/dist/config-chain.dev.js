...
regeneratorRuntime.mark(mergeExtendsChain),
    _marked5 =
/*#__PURE__*/
regeneratorRuntime.mark(mergeChainOpts);
...
function makeChainWalker(_ref6) {
  ...
  return (
    /*#__PURE__*/
    regeneratorRuntime.mark(function chainWalker(input, context) {
      var files,
          baseLogger,
          dirname,
          flattenedConfigs,
      ...
      return regeneratorRuntime.wrap(function chainWalker$(_context4) {
        while (1) {
  ...
  return regeneratorRuntime.wrap(function mergeChainOpts$(_context6) {
    while (1) {
      switch (_context6.prev = _context6.next) {
        case 0:
          options = _ref8.options, plugins = _ref8.plugins, presets = _ref8.presets;
...
function configIsApplicable(_ref9, dirname, context, configName) {
