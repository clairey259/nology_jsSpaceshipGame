...
({});
var transformFileRunner = gensync_1["default"](function (filename, opts) {
    var options, config, code;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                options = __assign(__assign({}, opts), { filename: filename });
                return [5 /*yield**/, __values(config_1["default"](options))];
            case 1:
                config = _a.sent();
                if (config === null)
            ...
            case 2:
                code = _a.sent();
                return [5 /*yield**/, __values(transformation_1.run(config, code))];
...
function transformFile() {
    ...
    return transformFileRunner.errback.apply(transformFileRunner, args);
}
