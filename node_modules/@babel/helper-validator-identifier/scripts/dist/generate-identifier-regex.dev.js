"use strict"; // Always use the latest available version of Unicode!
// https://tc39.github.io/ecma262/#sec-conformance

var version = "15.0.0";

var start = require("@unicode/unicode-" + version + "/Binary_Property/ID_Start/code-points.js").filter(function (ch) {
  return ch > 0x7f;
});

var last = -1;
var cont = [0x200c, 0x200d].concat(require("@unicode/unicode-" + version + "/Binary_Property/ID_Continue/code-points.js").filter(function (ch) {
