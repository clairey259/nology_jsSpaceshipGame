...
function argsert(arg1, arg2, arg3) {
  function parseArgs() {
    return _typeof(arg1) === 'object' ? [{
      demanded: [],
      optional: []
    }, arg1, arg2] : [(0, _parseCommand.parseCommand)("cmd ".concat(arg1)), arg2, arg3];
  }
  ...
  try {
    ...
    if (length < parsed.demanded.length) {
      throw new _yerror.YError("Not enough arguments provided. Expected ".concat(parsed.demanded.length, " but received ").concat(args.length, "."));
    }

    var totalCommands = parsed.demanded.length + parsed.optional.length;

    if (length > totalCommands) {
      throw new _yerror.YError("Too many arguments provided. Expected max ".concat(totalCommands, " but received ").concat(length, "."));
    }
...
function argumentTypeError(observedType, allowedTypes, position) {
  throw new _yerror.YError("Invalid ".concat(positionName[position] || 'manyith', " argument. Expected ").concat(allowedTypes.join(' or '), " but received ").concat(observedType, "."));
}