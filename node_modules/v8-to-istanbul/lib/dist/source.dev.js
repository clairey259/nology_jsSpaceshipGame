...
var _require = require('./range'),
    sliceRange = _require.sliceRange;

var _require2 = require('@jridgewell/trace-mapping'),
    originalPositionFor = _require2.originalPositionFor,
    generatedPositionFor = _require2.generatedPositionFor,
    GREATEST_LOWER_BOUND = _require2.GREATEST_LOWER_BOUND,
    LEAST_UPPER_BOUND = _require2.LEAST_UPPER_BOUND;
...
function () {
  ...
  _createClass(CovSource, [{
    ...
    value: function _buildLines(source) {
      ...
      try {
        for (var _iterator = source.split(/(?<=\r?\n)/).entries()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var ignoreToken = this._parseIgnore(lineStr);
    ...
    key: "_parseIgnore",
    value: function _parseIgnore(lineStr) {
      ...
      var testIgnoreStartStop = lineStr.match(_wrapRegExp(/\/\* c8 ignore (start|stop) *\*\//, {
        mode: 1
      }));
    ...
    value: function offsetToOriginalRelative(sourceMap, startCol, endCol) {
      var lines = sliceRange(this.lines, startCol, endCol, true);
...
function originalEndPositionFor(sourceMap, line, column) {
  ...
  var afterEndMapping = generatedPositionFor(sourceMap, {
...
function originalPositionTryBoth(sourceMap, line, column) {
  var original = originalPositionFor(sourceMap, {
    line: line,
    column: column,
  ...
  var min = originalPositionFor(sourceMap, {
    line: line,
    column: 0,
    bias: GREATEST_LOWER_BOUND
  });
