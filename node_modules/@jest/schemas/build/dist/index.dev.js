...
function _typebox() {
  var data = require('@sinclair/typebox');

  _typebox = function _typebox() {
    return data;
  };
...
var RawSnapshotFormat = _typebox().Type.Partial(_typebox().Type.Object({
...
var SnapshotFormat = _typebox().Type.Strict(RawSnapshotFormat);
