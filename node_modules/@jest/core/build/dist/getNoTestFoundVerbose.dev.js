...
function getNoTestFoundVerbose(testRunData, globalConfig, willExitWith0) {
  ...
  if (willExitWith0) {
    return "".concat(_chalk()["default"].bold('No tests found, exiting with code 0'), "\n").concat(individualResults.join('\n'), "\n").concat(dataMessage);
  }

  return "".concat(_chalk()["default"].bold('No tests found, exiting with code 1'), "\n") + 'Run with `--passWithNoTests` to exit with code 0' + "\n".concat(individualResults.join('\n'), "\n").concat(dataMessage);
}