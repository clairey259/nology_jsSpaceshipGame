...
function getProjectNamesMissingWarning(projectConfigs, opts) {
  ...
  return _chalk()["default"].yellow("You provided values for ".concat(args.join(' and '), " but ").concat(numberOfProjectsWithoutAName === 1 ? 'a project does not have a name' : "".concat(numberOfProjectsWithoutAName, " projects do not have a name"), ".\n") + 'Set displayName in the config of all projects in order to disable this warning.\n');
}