...
var TestNamePatternPrompt =
/*#__PURE__*/
function (_jestWatcher$PatternP) {
  _inherits(TestNamePatternPrompt, _jestWatcher$PatternP);

  function TestNamePatternPrompt(pipe, prompt) {
    _classCallCheck(this, TestNamePatternPrompt);

    return _possibleConstructorReturn(this, _getPrototypeOf(TestNamePatternPrompt).call(this, pipe, prompt, 'tests'));
  }

  _createClass(TestNamePatternPrompt, [{
    key: "_onChange",
    value: function _onChange(pattern, options) {
      _get(_getPrototypeOf(TestNamePatternPrompt.prototype), "_onChange", this).call(this, pattern, options);
