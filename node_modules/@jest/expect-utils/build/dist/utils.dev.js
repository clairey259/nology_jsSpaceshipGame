...
var iterableEquality = function iterableEquality(a, b) {
  ...
  if (!(0, _jasmineUtils.isImmutableList)(a) && !(0, _jasmineUtils.isImmutableOrderedKeyed)(a) && !(0, _jasmineUtils.isImmutableOrderedSet)(a) && !(0, _jasmineUtils.isImmutableRecord)(a)) {
...
var arrayBufferEquality = function arrayBufferEquality(a, b) {
  if (!(a instanceof ArrayBuffer) || !(b instanceof ArrayBuffer)) {
    return undefined;
  }

  var dataViewA = new DataView(a);
  var dataViewB = new DataView(b); // Buffers are not equal when they do not have the same byte length
...
var pathAsArray = function pathAsArray(propertyPath) {
  var properties = [];
  ...
  var pattern = RegExp('[^.[\\]]+|(?=(?:\\.)(?:\\.|$))', 'g'); // Because the regex won't match a dot in the beginning of the path, if present.

  if (propertyPath[0] === '.') {
    properties.push('');
  }

  propertyPath.replace(pattern, function (match) {
