...
var MOCKS_PATTERN = new RegExp((0, _jestRegexUtil().escapePathForRegex)("".concat(path().sep, "__mocks__").concat(path().sep)));
...
function shouldInstrument(filename, options, config) {
  ...
  options.collectCoverageFrom.length && !(0, _jestUtil().globsToMatcher)(options.collectCoverageFrom)((0, _jestUtil().replacePathSepForGlob)(path().relative(config.rootDir, filename)))) {
    return false;
  }
