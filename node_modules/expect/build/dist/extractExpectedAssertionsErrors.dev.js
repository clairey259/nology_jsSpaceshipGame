...
var extractExpectedAssertionsErrors = function extractExpectedAssertionsErrors() {
  ...
  if (typeof expectedAssertionsNumber === 'number' && assertionCalls !== expectedAssertionsNumber) {
    ...
    expectedAssertionsNumberError.message = "".concat((0, _jestMatcherUtils.matcherHint)('.assertions', '', expectedAssertionsNumber.toString(), {
      isDirectExpectCall: true
    }), "\n\n") + "Expected ".concat(numOfAssertionsExpected, " to be called but received ").concat((0, _jestMatcherUtils.RECEIVED_COLOR)((0, _jestMatcherUtils.pluralize)('assertion call', assertionCalls || 0)), ".");
    result.push({
  ...
  if (isExpectingAssertions && assertionCalls === 0) {
    ...
    isExpectingAssertionsError.message = "".concat((0, _jestMatcherUtils.matcherHint)('.hasAssertions', '', '', {
      isDirectExpectCall: true
