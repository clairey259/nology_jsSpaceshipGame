...
var _Symbol = globalThis['jest-symbol-do-not-touch'] || globalThis.Symbol; // Global matchers object holds the list of available matchers and
...
var getState = function getState() {
  return globalThis[JEST_MATCHERS_OBJECT].state;
};
...
var getMatchers = function getMatchers() {
  return globalThis[JEST_MATCHERS_OBJECT].matchers;
};
...
var setMatchers = function setMatchers(matchers, isInternal, expect) {
  Object.keys(matchers).forEach(function (key) {
    ...
    if (typeof matcher !== 'function') {
      throw new TypeError("expect.extend: `".concat(key, "` is not a valid matcher. Must be a function, is \"").concat((0, _jestGetType.getType)(matcher), "\""));
    }
    ...
    if (!isInternal) {
      ...
      function (_asymmetricMatchers$A) {
        ...
        function CustomMatcher() {
          ...
          return _possibleConstructorReturn(this, _getPrototypeOf(CustomMatcher).call(this, sample, inverse));
        }

        _createClass(CustomMatcher, [{
          key: "asymmetricMatch",
          value: function asymmetricMatch(other) {
            var _matcher$call = matcher.call.apply(matcher, [this.getMatcherContext(), other].concat(_toConsumableArray(this.sample))),
                pass = _matcher$call.pass;
