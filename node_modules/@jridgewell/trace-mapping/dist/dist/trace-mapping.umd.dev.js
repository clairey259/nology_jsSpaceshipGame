...
(function (global, factory) {
  ...
  var resolveUri__default =
  /*#__PURE__*/
  _interopDefaultLegacy(resolveUri);
  ...
  function buildBySources(decoded, memos) {
    ...
    for (var i = 0; i < decoded.length; i++) {
      ...
      for (var j = 0; j < line.length; j++) {
        ...
        var memo = memos[sourceIndex]; // The binary search either found a match, or it found the left-index just before where the
  ...
  function addSection(input, mapUrl, mappings, sources, sourcesContent, names, lineOffset, columnOffset, stopLine, stopColumn) {
    ...
    for (var _i = 0; _i < decoded.length; _i++) {
      var lineI = lineOffset + _i; // We can only add so many lines before we step into the range that the next section's map
  ...
  (function () {
    ...
    exports.traceSegment = function (map, line, column) {
      var decoded = exports.decodedMappings(map); // It's common for parent source maps to have pointers to lines that have no
